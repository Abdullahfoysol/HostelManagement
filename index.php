...
//change colg name
$q2 = "SELECT unigname FROM admin WHERE id=1";
$q21 = mysqli_query($con,$q2);
$unigdisp = mysqli_fetch_array($q21);

//change intro content
$q3 = "SELECT unigintro FROM admin WHERE id=1";
...
<html>
<head>
<title>Sample University Project</title>
...
<table width="1050px" align="center"  border="1">
  <tbody>
    <tr>
      <th height="39" colspan="2" style="background-color:#addf8b"><div style="text-align:left;color:purple"><b><font size="+3"><a href="index.php" style="text-decoration:none ; color:#FFFFFF"><?php echo $unigdisp['unigname'];?></a></font></b><marquee direction="left" height="100%">
...
<li><img src="data1/images/banner_01.jpg" alt="Meropolitan University Campus" title="Metropolitan University Campus" id="wows1_0"/></li>
...
<a href="#" title="Metropolitan University Campus"><img src="data1/tooltips/banner_01.jpg" alt="Metropolitan University Campus"/>1</a>
...
<span class="wsl"></span>
    ...
    <tr>
      <td height="38" colspan="2" style="background-color:#F487F3">
	...
	?>
	<center>
	  <h2><b><font size="+3"><?php echo $unigdisp['unigname'];?>
	    </font></b></h2>
	</center>
    <center><img src="images/colg.jpg" width="696" height="488"></center>
    <p><center>
      <p>&nbsp;</p>
      <p><strong><font size="+2"><?php echo $unigdisp['unigname'];?></font></strong> <b>-</b> <font size="+1"><?php echo $introdisp['unigintro']; ?></font></p>
    </center></p>
	<?php
    error_reporting(1);
	}
	...
	?>
      ...
      <center><font size="+2"><b style="color:#191B7E"><div style="background-color:#969BFB">University Updates</div><br></b></font></center>
      	<marquee direction="up" height="100%" onMouseOver="stop()" onMouseOut="start()">
            ...
            <center><a href="index.php?option=admission" style="text-decoration:none"><font size="+1"><b>Admission 2020</b></font></a></center><br>
    ...
    <tr>
	  ...
	  <td height="25" colspan="2" style="background-color:#5ACEA8"><center><b>Copyright Abdullah Al Foysol &copy; <?php echo date("Y") ?> </b></center>
